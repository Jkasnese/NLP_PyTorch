...
def run_loop(BATCH_SIZE, NUM_HIDDEN, OPTIMIZER, LEARNING_RATE, LOSS_FUNC):
    ...
    data_iter = DataLoader(data, batch_size=BATCH_SIZE, shuffle=True, collate_fn=cProfile("generate_batch").__iter__()
...
# sgd = "sgd"
# cross="cross"
# cProfile.run("run_loop(256, 64, sgd, 0.1, cross)", "w_valid_loss.cProfile.prof")
